...
class AppointmentsRepository {
    ...
    if (_storage.appointments.isNotEmpty) {
      ...
      try {
        ...
        if (json.decode(response.body) != null) {
          // print('income json: ${json.decode(response.body)}');
  ...
  Future<Appointment> removeAppointment(DateTime day) async {
    ...
    try {
      ...
      final Appointment selectedAppointment = _storage.appointments.firstWhere(
  ...
  Appointment get getNearestAppointment {
    ...
    return _storage.appointments.firstWhere(
      (entry) {
        return entry.day.isAfter(
          DateTime.now(),
        );
      },
      orElse: () => null,
